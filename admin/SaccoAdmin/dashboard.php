...
<head>
	...
	<title>Matatu Booking System | Admin Dashboard</title>
...
<?php
$sql ="SELECT id from cyrus_users_table ";
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
												<?php
$sql1 ="SELECT id from cyrus_Buses_table ";
$query1 = $dbh -> prepare($sql1);;
$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$totalBus=$query1->rowCount();
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($totalBus);?></div>
													<div class="stat-panel-title text-uppercase">Listed Matatus</div>
												</div>
											</div>
											<a href="manage-Buses.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php
$sql2 ="SELECT id from cyrus_booking_table ";
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
<?php
$sql3 ="SELECT id from cyrus_Busestarting_Points_table ";
$query3= $dbh -> prepare($sql3);
$query3->execute();
$results3=$query3->fetchAll(PDO::FETCH_OBJ);
$Starting_Points=$query3->rowCount();
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($Starting_Points);?></div>
													<div class="stat-panel-title text-uppercase">Total Destinations</div>
												</div>
											</div>
											<a href="manage-Starting_Points.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light">
												<div class="stat-panel text-center">
<?php
$sql4 ="SELECT id from cyrus_subscribers_table ";
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
												<?php
$sql6 ="SELECT id from cyrus_contactusquery_table ";
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php
$sql5 ="SELECT id from cyrus_testimonials_table ";
