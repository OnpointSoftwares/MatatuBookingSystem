...
<ul>
<li><a href="manage-Starting_Points.php">View Destinations</a></li>
</ul>
</li>

<li><a href="#"><i class="fa fa-sitemap"></i> Matatus </a>
					<ul>
						<li><a href="manage-Buses.php">View Matatus</a></li>
					</ul>
				</li>
				<li><a href="manage-bookings.php"><i class="fa fa-users"></i> View Bookings</a></li>
