...
$sql="update cyrus_Buses_table set Vimage5=:vimage where id=:id";
...
<head>
	...
	<title>Limo Transport Sacco | Admin Update Image 5</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Bus Image 5 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Bus Image 5 Details</div>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage5 from cyrus_Buses_table where cyrus_Buses_table.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
