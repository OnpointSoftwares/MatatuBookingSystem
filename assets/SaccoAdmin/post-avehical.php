...
$sql="INSERT INTO cyrus_Buses_table(BusesTitle,BusesStarting_Point,BusesOverview,PricePerPerson,Busestop,ModelYear,SeatingCapacity,PlateNumber,Vimage1,Vimage2,Vimage3,Vimage4,Vimage5,AirConditioner,AntiLockBrakingSystem,PassengerAirbag,LeatherSeats) VALUES(:Bustitle,:Starting_Point,:Busoverview,:PricePerPerson,:Busestop,:modelyear,:seatingcapacity,:platenumber,:vimage1,:vimage2,:vimage3,:vimage4,:vimage5,:airconditioner,:antilockbrakingsys,:passengerairbag,:leatherseats)";
...
<head>
	...
	<title>Limo Transport Sacco | Admin Post Bus</title>
