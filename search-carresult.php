...
<title>Odhiambo Atieno Transport Sacco | Car Listing</title>
<!--Bootstrap -->
...
$sql = "SELECT id from cyrus_Buses_table where cyrus_Buses_table.BusesStarting_Point=:Starting_Point and cyrus_Buses_table.Busestop=:Busestop";
...
$sql = "SELECT cyrus_Buses_table.*,cyrus_Busestarting_Points_table.Starting_Point,cyrus_Busestarting_Points_table.id as bid  from cyrus_Buses_table join cyrus_Busestarting_Points_table on cyrus_Busestarting_Points_table.id=cyrus_Buses_table.BusesStarting_Point where cyrus_Buses_table.BusesStarting_Point=:Starting_Point and cyrus_Buses_table.Busestop=:Busestop";
$query = $dbh -> prepare($sql);
$query -> bindParam(':Starting_Point',$Starting_Point, PDO::PARAM_STR);
$query -> bindParam(':Busestop',$Busestop, PDO::PARAM_STR);
$query->execute();
        ...
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <ul>
              ...
              <li><i class="fa fa-car" aria-hidden="true"></i><?php echo htmlentities($result->Busestop);?></li>
            </ul>
...
<?php }} ?>
              ...
              <div class="form-group select">
                <select class="form-control">
                  <option>Select Stopping Point</option>
									<?php $sql = "SELECT * from  cyrus_Busestarting_Points_table ";
		$query = $dbh -> prepare($sql);
		$query->execute();
		$results=$query->fetchAll(PDO::FETCH_OBJ);
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> Recently Added Buses</h5>
          </div>
