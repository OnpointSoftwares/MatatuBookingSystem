      ...
      <center>
         <form style="padding-top: 150px;" action="MpesaTest.php" method="POST">
            <fieldset style="width: 400px; height: 300px; background-color: white;">
               <label style="padding-top: 200px;color:red;">Make Payment to complete your booking</label>
               <br>
               <input class="input2" type="number" name="amount" value="<?php echo $price;?>" placeholder="Enter Amount" style="margin-top: 60px;" readonly>
               <br><br>
