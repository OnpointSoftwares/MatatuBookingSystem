...
$consumer_key = 'P6SdXw53DGONQZDGyfjFUWkC7cvCwaqX';
$consumer_secret = 'GY5qsRIWTEsYGmuz';
...
$CallBackURL = 'https://2f50f430.ngrok.io/callback.php?key=ZfQrNmDyOlL4V2T0qnpnGv8NikED';
...
$curl_Tranfer2_post_data = [
    ...
    'AccountReference' => 'Matatu Booking System',
    'TransactionDesc' => 'Paying for fare',
];
...
echo "<script>alert('Enter your mpesa pin to complete the booking process')</script>";
header("location:../index.php?id=payment");
?>
