...
$sql="update cyrus_users_table set FullName=:name,ContactNo=:mobileno,dob=:dob,Address=:adress,City=:city,Country=:country where EmailId=:email";
...
<title>Matatu Booking System | My Profile</title>
<!--Bootstrap -->
