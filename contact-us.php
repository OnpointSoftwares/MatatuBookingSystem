...
$sql="INSERT INTO  cyrus_contactusquery_table(name,EmailId,ContactNumber,Message) VALUES(:name,:email,:contactno,:message)";
...
<title>BusForYou- Matatu Booking system</title>
<!--Bootstrap -->
    ...
    <div  class="row">
      ...
      <div class="col-md-6">
        ...
        <div class="contact_detail">
              <?php 
$pagetype=$_GET['type'];
$sql = "SELECT Address,EmailId,ContactNo from cyrus_contactus_table";
$query = $dbh -> prepare($sql);
