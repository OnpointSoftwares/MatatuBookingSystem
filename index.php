...
{
  ?>
<script>alert("Enter Mpesa Pin On Your Phone To complete your transaction:"); </script>
  <?php
}
?>
...
<title>Matatu Booking System | Matatu Listing</title>
<!--Bootstrap -->
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Find Matatu en' Route </h5>
          </div>
...
<?php }} ?>
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> Search For a Matatu</button>
              </div>
            </form>
          </div>
        </div>
